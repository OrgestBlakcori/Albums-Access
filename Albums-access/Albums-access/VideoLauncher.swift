...
//
//MARK: - YouTube like video player
import UIKit
import AVFoundation
...
class VideoPlayerView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        pausePlayButton.leftAnchor.constraint(equalTo: leftAnchor, constant: 8).isActive = true
        pausePlayButton.bottomAnchor.constraint(equalTo: bottomAnchor).isActive = true
        pausePlayButton.contentHorizontalAlignment = videoSlider.contentHorizontalAlignment

        controlsContainerView.addSubview(videoLengthLabel)
        videoLengthLabel.rightAnchor.constraint(equalTo: rightAnchor, constant: -8).isActive = true
        videoLengthLabel.bottomAnchor.constraint(equalTo: bottomAnchor).isActive = true
        videoLengthLabel.widthAnchor.constraint(equalToConstant: 60).isActive = true
        videoLengthLabel.heightAnchor.constraint(equalToConstant: 70).isActive = true
...
//        currentTimeLabel.heightAnchor.constraint(equalToConstant: 70).isActive = true

        controlsContainerView.addSubview(videoSlider)
        videoSlider.rightAnchor.constraint(equalTo: videoLengthLabel.leftAnchor).isActive = true
        videoSlider.bottomAnchor.constraint(equalTo: bottomAnchor).isActive = true
        videoSlider.leftAnchor.constraint(equalTo: pausePlayButton.rightAnchor).isActive = true
        videoSlider.heightAnchor.constraint(equalToConstant: 70).isActive = true
